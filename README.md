...
### Part 3
1. When starting a new project I will first identify the game's mechanics/loop. This will likely determine the type/genre of the game I’m making.
2. I will then find references to games that have similar mechanics and take notes on what works and what could be improved.
3. Once I have those, I will begin to draw these mechanics into systems to see how they interconnect with other mechanics in the game that I want to add to make sure that they work as a system and if it sounds like a fun loop. 
4. When I get to a point where I’m satisfied with the loop of the core game, I will identify the variables/components that I will need to support these mechanics and systems so that they work as I intend in my game. 
5. After compiling all these ideas and variables I need, I will use a breakdown chart to track and visualize the development list for each item. By having a breakdown chart, it creates a central place where any other developer and I can refer back to to see the list of things to complete. It serves as a checklist and a reminder for the team. Also by drawing it out we can see how much content visually we are trying to produce. When coming up with ideas, it’s really easy to over complicate and add to many mechanics that you won’t have time to implement. So by breaking down your game into these visual systems, it allows the developers to see the scope of the game and can estimate the time required to implement everything. If things seem unreasonable for the scope, the planning phase is the best place to find and remove that since it’ll be a waste of time and man power if found out later. Keeping the scope in mind is very important because too much content can make you miss deadlines and cause developers to work way over time. 
6. After planning, before implementation, I will start breaking down each task using a "task breakdown" that will prove helpful and speed up the process. This is because you're making a course of action so when you head into the engine, generally knowing what to do will save time since you thought it through already. I found myself working faster after I made a plan before any code and thought of what variables I need for each script beforehand. 
7. After getting all these mechanical parts ready, I will move on to a mood board and start detailing what I want the game to look and feel like. Creating a mood board is very useful in establishing art in the game since this is what players will remember most by the visual identity. As an artist, I like to create a mood board for the world and sketch characters that will fit into this world. Then subsequently create moodboards for each character to establish personalities and designs. 
8. After all this preproduction, I will start drawing and implementing a few features every week and slowly start building a full game. 
9. This process is similar to what we did for this vertical slice project where I both had to draw up a bubble breakdown chart, mood boards, and break down implementation steps. Something that did affect my project was over-scoping in the beginning because I was inexperienced and didn’t fully understand how long things would take to implement. But after doing the project and getting more experience, I can now estimate what's possible in the given time frame and can plan better in future projects. I think breakdowns are useful for every developer, however its a more powerful tool to a more experienced developer since they have experience on how long things generally take and aren’t just listing cool things they want in their games. Despite this, having the breakdown charts did help me track things to do and the interactions different variables will have in my game which kept things organized and kept development on track. 
